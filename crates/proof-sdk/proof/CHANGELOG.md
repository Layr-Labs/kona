...
## [0.2.0](https://github.com/Layr-Labs/kona/compare/kona-proof-v0.1.0...kona-proof-v0.2.0) - 2024-12-03

### Added

- *(driver)* wait for engine ([#851](https://github.com/Layr-Labs/kona/pull/851))
- *(client)* Invalidate impossibly old claims ([#852](https://github.com/Layr-Labs/kona/pull/852))
- *(driver)* refines the executor interface for the driver ([#850](https://github.com/Layr-Labs/kona/pull/850))
- *(workspace)* Isolate FPVM-specific platform code ([#821](https://github.com/Layr-Labs/kona/pull/821))

### Other

- *(host)* Hint Parsing Cleanup ([#844](https://github.com/Layr-Labs/kona/pull/844))
- *(derive)* remove indexed blob hash ([#847](https://github.com/Layr-Labs/kona/pull/847))
- L2ExecutePayloadProof Hint Type ([#832](https://github.com/Layr-Labs/kona/pull/832))
